...
public class creatUserForm extends javax.swing.JFrame {
     ...
     */
    public creatUserForm(AdminUI adminUI) {
    ...
    private void initComponents() {
        ...
        addUserButton.setForeground(new java.awt.Color(51, 255, 51));
    ...
    private void addUser() {
        ...
        try {
            ...
            if (adminUI.company.addUser(name, password, id, new Address(streetNumber, streetName, suburb, city))) {
                JOptionPane.showMessageDialog(this, "User added succsesfully");
            } else {
                JOptionPane.showMessageDialog(this, "Faild to add User (Be sure of a unique ID)");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e);
        }
